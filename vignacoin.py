...
def connect_node():
    ...
    response = {
        'message': "all nodes are now connected. The vignacoin blockchain contains the following nodes.",
...
def replace_chain():
    ...
    if is_chain_replaced:
        response={'message': 'the nodes has different chains. The chain is replaced by longest one.',
